...
const tokenResponse = { session_token: "wxsess_7jX9Qp2Lm8Vn4Rt6Yw3Kc5Hd1Bs0Fa9Eu7Gi2No6Zx4", expires_at: "2099-01-01T00:00:00Z", user: { id: "00000000-0000-4000-8000-000000000001", masked_phone: null, last_contact_name: null } };
...
function createHarness() {
  ...
  return { source: createHttpPitchConfigurationDataSource({ transport, identity, sessionStore: createSessionStore(storage, () => Date.parse("2026-08-11T00:00:00Z")) }), get, post, put };
}
