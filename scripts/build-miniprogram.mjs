...
async function writeProductionAppBootstrap(sourceRoot, outputRoot, notificationConfig) {
  ...
  const bootstrappedSource = [
    ...
    'import { registerOpenGameReportAttemptStore, registerOpenGameReportSource } from "./services/open-game-report";',
...
async function prepareDevelopmentFixtureData(projectRoot) {
  ...
  const expectedNames = [
    ...
    "open-game-signup-context-anonymous",
    "open-game-signup-context-applied",
    "open-game-signup-context-apply-ready",
    "open-game-signup-context-cancelled",
    "open-game-signup-context-joined",
    "open-game-signup-context-rejected",
    "order-confirmed",
    "order-expired",
  ...
  const canonicalNames = {
    ...
    "open-game-signup-context-anonymous": "open-game-signup-context-anonymous.json",
    "open-game-signup-context-applied": "open-game-signup-context-applied.json",
    "open-game-signup-context-apply-ready": "open-game-signup-context-apply-ready.json",
    "open-game-signup-context-cancelled": "open-game-signup-context-cancelled.json",
    "open-game-signup-context-joined": "open-game-signup-context-joined.json",
    "open-game-signup-context-rejected": "open-game-signup-context-rejected.json",
