...
- 两个页面均为 production disabled 的独立 visual Artifact。
...
| Category | first-entry | returning-home |
| --- | --- | --- |
| composition | 待取证 | 待取证 |
| geometry/spacing | 待取证 | 待取证 |
| component hierarchy | 待取证 | 待取证 |
| typography/color/material | 待取证 | 待取证 |
| icon assets | 待取证 | 待取证 |
| copy | 待取证 | 待取证 |
| state semantics | 待取证 | 待取证 |
