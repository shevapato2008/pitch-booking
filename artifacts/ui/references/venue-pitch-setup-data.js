...
Object.assign(states, {
  ...
  "first-save-success": {
    ...
    pageAction: pageAction("打开 A场时段设置"),
  },
  "six-pitch-list": {
    id: "six-pitch-list",
    mode: "list",
  ...
  "edit-preset-open": {
    ...
    pitches: PITCHES,
    editor: {
      title: "编辑物理场地", nameValue: "A场", selectedFormat: 7, customInput: false,
      completeLabel: "完成", lifecycleAction: { label: "停用场地", disabled: false },
    },
    pageAction: pageAction("保存更改"),
  },
  "edit-custom-open": {
  ...
  "field-validation": {
    ...
    editor: {
      title: "编辑物理场地", nameValue: "A场", selectedFormat: 7, customInput: false,
      fieldError: "场地名称已被使用，请换一个名称", completeLabel: "完成", lifecycleAction: null,
    },
    pageAction: pageAction("保存更改"),
  },
  "deactivate-blocked": {
    ...
    editor: {
      ...
      completeLabel: "完成", lifecycleAction: { label: "停用场地", disabled: true },
  ...
  "unused-delete-confirm": {
    ...
    editor: {
      ...
      completeLabel: "完成", lifecycleAction: { label: "删除场地", disabled: false },
      confirmation: {
  ...
  "deactivated-draft": {
    ...
    pitches: withPitch("pitch-7-003", { status: "INACTIVE", draft_status: "INACTIVE · 已停用 · 待保存" }),
    pageAction: pageAction("保存更改"),
  },
  "reactivated-draft": {
    ...
    pitches: withPitch("pitch-7-004", { status: "ACTIVE", draft_status: "ACTIVE · 使用中 · 待保存" }),
    pageAction: pageAction("保存更改"),
  },
  "save-in-progress": {
    id: "save-in-progress",
